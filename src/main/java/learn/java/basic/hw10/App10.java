...
public class App10 {
    public static void main(String[] args) {
        ...
        users[3] = new User("Nikolaey","Igor","Borisovich",50,"NikolaeyIB@mail.com");
        users[4] = new User("Abramov","Aleksey","Vasilevich",25,"AbramovAV@mail.com");
